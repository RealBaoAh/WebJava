...
%>
          ...
          <th scope="col"><a href="myCart.jsp"><i class='fas fa-arrow-circle-left'> Back</i></a></th>
            <th scope="col" style="background-color: yellow;">Total:<%out.println(total);%><i class="fa fa-dollar-sign"></i></th>
          </tr>
        </thead>
        <thead>
          <tr>
...
%>
          ...
          <%sno=sno+1; %>
           <td><%out.println(sno);%></td>
            ...
            <td><%=rs.getString(4)%><i class="fa fa-dollar-sign"></i> </td>
            <td><%=rs.getString(8)%> </td>
            <td><%=rs.getString(10)%><i class="fa fa-dollar-sign"></i> </td>
            </tr>
         <%}
...
<button class="button" typr="submit">Proceed to generate Bill & Save <i class='far fa-arrow-alt-circle-right'></i></button>
